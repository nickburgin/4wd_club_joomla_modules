...
<form
	...
	method="post" enctype="multipart/form-data" name="adminForm" id="action-form" class="form-validate">

	<?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', array('active' => 'general')); ?>

	<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'general', Text::_('COM_GAUSERS_TITLE_ACTION', true)); ?>
		<div class="row-fluid">
