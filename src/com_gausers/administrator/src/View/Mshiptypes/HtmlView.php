...
namespace GlennArkell\Component\Gausers\Administrator\View\Mshiptypes;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.created_date' => Text::_('COM_GAUSERS_CREATED_DATE'),
			'a.modified_date' => Text::_('COM_GAUSERS_MODIFIED_DATE'),
		);
	}
