 ...
 * @since  1.6.0
 */
class MshiptypesController extends AdminController
{
	/**
	 * Method to clone existing Mshiptypes
	 * @return void
     * @throws Exception
	 */
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_gausers&view=mshiptypes');
	}
	 ...
	 * @since    1.6
	 */
	public function getModel($name = 'Mshiptype', $prefix = 'Administrator', $config = array('ignore_request' => true))
	{
