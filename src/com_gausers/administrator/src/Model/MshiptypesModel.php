 ...
 * @since  1.6
 */
class MshiptypesModel extends ListModel
{
...
/**
	...
	*/
	public function __construct($config = array())
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = array(
				...
				'ordering', 'a.ordering',
				'title', 'a.title',
				'joining_fee', 'a.joining_fee',
				'subscrib_amt', 'a.subscrib_amt',
				'term_type', 'a.term_type',
				'mship_term', 'a.mship_term',
			);
		}
	...
	protected function getListQuery()
	{
		...
		$query->from('#__gausers_mshiptypes AS a');
