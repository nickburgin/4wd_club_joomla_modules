...
class InvoiceformController extends FormController
{
	...
	public function edit($key = NULL, $urlVar = NULL)
	{
		...
		$this->setRedirect(Route::_('index.php?option=com_gausers&view=invoiceform&layout='.$layout, false));
	}
	...
	public function save($key = NULL, $urlVar = NULL)
	{
		...
		if ($data === false) {
			...
			$app->setUserState('com_gausers.edit.invoice.data', $jform);

			// Redirect back to the edit screen.
			$id = (int) $app->getUserState('com_gausers.edit.invoice.id');
			$this->setRedirect(Route::_('index.php?option=com_gausers&view=invoiceform&layout=edit&id=' . $id, false));
	...
	public function cancel($key = NULL)
	{
		...
		$editId = (int) $app->getUserState('com_gausers.edit.invoice.id');
		...
		$item = $menu->getActive();
		$url  = (empty($item->link) ? 'index.php?option=com_gausers&view=invoices' : $item->link);
	...
	public function remove()
    {
        ...
        try
        {
            ...
            $this->setRedirect('index.php?option=com_gausers&view=invoices');
    ...
    public function markAsPaid()
	{
		...
		// Redirect to the list screen.
		$this->setMessage(Text::_('COM_GAUSERS_MARKPAID_SUCCESSFULLY').' - '.$data['user_name']);
