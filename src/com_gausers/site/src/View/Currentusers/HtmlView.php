 ...
 */
namespace GlennArkell\Component\Gausers\Site\View\Currentusers;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null)
	{
        ...
        $this->rpt_type     = $this->params->get('rpt_type');
        $this->xtra     = $this->params->get('profile_params');
        $this->exclude_group = $this->params->get('exclude_group');
