 ...
 * @since  1.6
 */
class BcastsModel extends ListModel
{
...
/**
	...
	*/
	public function __construct($config = array())
	{
		if (empty($config['filter_fields']))
		{
			$config['filter_fields'] = array(
                ...
                'attach_lab', 'a.attach_lab',
                'attach_dir', 'a.attach_dir',
				'comment', 'a.`comment`',
			);
		}
	...
	protected function populateState($ordering = null, $direction = null)
	{
        ...
        $context = $this->getUserStateFromRequest($this->context . '.context', 'context', 'com_gabroadcast.bcasts', 'CMD');
	...
	protected function getListQuery()
	{
		...
		if (!empty($search)) {
			if (stripos($search, 'id:') === 0) {
				...
				$query->where('( a.attach_lab LIKE ' . $search . ' )');
			}
		}
