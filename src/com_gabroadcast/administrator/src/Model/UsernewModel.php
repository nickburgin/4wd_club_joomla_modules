 ...
 * @since  1.6
 */
class UsernewModel extends AdminModel
{
	/**
	 ...
	 * @since   3.2
	 */
	public $typeAlias = 'com_gabroadcast.usernew';
	...
	public function getForm($data = array(), $loadData = true)
	{
            ...
            // Get the form.
            $form = $this->loadForm( 'com_gabroadcast.usernew', 'usernew', array('control' => 'jform', 'load_data' => $loadData ) );
	...
	protected function prepareTable($table)
	{
		...
		if (empty($table->id))
		{
			...
			if (@$table->ordering === '')
			{
				...
				$db->setQuery('SELECT MAX(ordering) FROM #__gabroadcast_usernews');
				$max             = $db->loadResult();
