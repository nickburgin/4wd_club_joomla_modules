 ...
 * @since  1.6
 */
class BcastTable extends Table implements VersionableTableInterface
{
	...
	{
		$this->typeAlias = 'com_gabroadcast.bcast';
		parent::__construct('#__gabroadcast_bcasts', 'id', $db);
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!$user->authorise('core.admin', 'com_gabroadcast.bcast.' . $array['id'])) {
			$actions         = Access::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_gabroadcast/access.xml',
				"/access/section[@name='bcast']/"
			);
			$default_actions = Access::getAssetRules('com_gabroadcast.bcast.' . $array['id'])->getData();
			$array_jaccess   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_gabroadcast.bcast.' . (int) $this->$k;
	}
