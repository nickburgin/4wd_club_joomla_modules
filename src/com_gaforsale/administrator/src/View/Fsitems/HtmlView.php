...
namespace GlennArkell\Component\Gaforsale\Administrator\View\Fsitems;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null)
	{
        ...
        HTMLHelper::stylesheet(Uri::base().'media/com_gaforsale/css/gaforsale.css');
        HTMLHelper::stylesheet(Uri::base().'media/com_gaforsale/css/list.css');
	...
	protected function addToolbar()
	{
		...
		$canDo = ContentHelper::getActions('com_gaforsale','component',0);

		$customIcon = '';

		if (file_exists(JPATH_SITE . '/media/com_gaforsale/images/l_'.$progNameL.'s.png')) {
		...
		if ($canDo->get('core.admin')) {
			$toolbar->preferences('com_gaforsale');
		}

		// Set sidebar action
		//\JHtmlSidebar::setAction('index.php?option=com_gabarebone&view='.$progNameL.'s');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`created_date`' => Text::_('COM_GAFORSALE_CREATED_DATE'),
			'a.`modified_date`' => Text::_('COM_GAFORSALE_MODIFIED_DATE'),
		);
	}
