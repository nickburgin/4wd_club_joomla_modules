...
ALTER TABLE `#__gaforsale_fsitems` CHANGE `ordering` `ordering` INT NOT NULL DEFAULT 0;
ALTER TABLE `#__gaforsale_fsitems` CHANGE `checked_out` `checked_out` INT NULL;
ALTER TABLE `#__gaforsale_fsitems` CHANGE `created_by` `created_by` INT NOT NULL DEFAULT 0;
...
ALTER TABLE `#__gaforsale_fsitems` CHANGE `user_id` `user_id` INT NOT NULL DEFAULT 0;
