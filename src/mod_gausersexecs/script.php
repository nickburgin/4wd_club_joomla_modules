 ...
 */
class mod_gausersexecsInstallerScript extends InstallerScript
{
	/**
	...
	public function preflight($type, $parent)
	{
		...
		echo '<p>' . Text::_('MOD_GAUSERSEXECS_PREFLIGHT_TEXT') . '</p>';

        $path = Path::clean( JPATH_SITE . '/modules/mod_gausersexecs/' );
        $this->deleteFiles($path, 'helper', '.php');
        $this->deleteFiles($path, 'mod_gausersexecs', '.php');
