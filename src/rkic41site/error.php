...
if (($this->error->getCode()) == '404') {
    if ($this->params->get('incl_defaulterror')) {
        header('Location: '.$this->params->get('defaulterror'));
        exit;
    }
}
...
// Template path
$templatePath = 'media/templates/site/rkic41site';

// Color Theme
$wa->registerAndUseStyle('theme.customuser', $templatePath . '/css/rkic41site.css');
