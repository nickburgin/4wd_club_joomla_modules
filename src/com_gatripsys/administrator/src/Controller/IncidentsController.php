...
class IncidentsController extends AdminController
{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Incident', $prefix = 'Administrator', $config = array('ignore_request' => true))
	{
	...
	public function duplicate()
	{
		...
		$this->setRedirect('index.php?option=com_gatripsys&view=incidents');
	}
