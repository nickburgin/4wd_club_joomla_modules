...
class AttendeeModel extends AdminModel
{
	 ...
	 * @since   3.2
	 */
	public $typeAlias = 'com_gatripsys.attendee';
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_gatripsys.attendee', 'attendee', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function prepareTable($table)
	{
		if (empty($table->id)) {
			...
			if (@$table->ordering === '') {
				...
				$db->setQuery('SELECT MAX(ordering) FROM #__gatripsys_attendees');
				$max = $db->loadResult();
