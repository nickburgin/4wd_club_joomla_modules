...
class AttendeeTable extends Table implements VersionableTableInterface
{
	...
	{
		$this->typeAlias = 'com_gatripsys.attendee';
		parent::__construct('#__gatripsys_attendees', 'id', $db);
    ...
    public function bind($array, $ignore = '') 
	{
		...
		if (!$user->authorise('core.admin', 'com_gatripsys.attendee.' . $array['id'])) {
			$actions = Access::getActionsFromFile( JPATH_ADMINISTRATOR . '/components/com_gatripsys/access.xml', "/access/section[@name='attendee']/" );
			$default_actions = Access::getAssetRules('com_gatripsys.attendee.' . $array['id'])->getData();
			$array_Access   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_gatripsys.attendee.' . (int) $this->$k;
	}
