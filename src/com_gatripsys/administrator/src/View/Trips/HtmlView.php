...
namespace GlennArkell\Component\Gatripsys\Administrator\View\Trips;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
        ...
        $compVersion = GatripsysHelper::getComponentVersion();
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.`created_date`' => Text::_('COM_GATRIPSYS_CREATED_DATE'),
			'a.`modified_date`' => Text::_('COM_GATRIPSYS_MODIFIED_DATE'),
		);
	}
