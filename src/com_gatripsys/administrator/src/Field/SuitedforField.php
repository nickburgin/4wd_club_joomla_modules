...
class SuitedforField extends ListField
{
    /**
     * The field type.
     * @var         string
     */
    protected $type = 'Suitedfor';
    ...
    {
        $options = array("0"=>" - Select Suitability - ");

        $xoptions = GatripsysHelper::getCategoryOptions('com_gatripsys.suitedfor');
