...
class TriptypeField extends ListField
{
    /**
     * The field type.
     * @var         string
     */
    protected $type = 'Triptype';
    ...
    {
        $options = array("0"=>" - Select Trip Type - ");

        $xoptions = GatripsysHelper::getCategoryOptions('com_gatripsys.triptype');
