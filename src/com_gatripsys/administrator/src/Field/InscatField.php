...
class InscatField extends ListField
{
    /**
     * The field type.
     * @var         string
     */
    protected $type = 'Inscat';
    ...
    {
        $options = array("0"=>" - Select Insurance - ");

        $xoptions = GatripsysHelper::getCategoryOptions('com_gatripsys.inscat');
