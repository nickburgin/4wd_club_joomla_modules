...
class TripleadersField extends ListField
{
    /**
     * The field type.
     * @var         string
     */
    protected $type = 'Tripleaders';
    ...
    protected function getOptions()
    {
		...
		if ($restrict_leader) {
			$options = GatripsysHelper::getTripleadersOptions('Tripleader');
		} else {
			$options = GatripsysHelper::getMembershipOptions();
		}
