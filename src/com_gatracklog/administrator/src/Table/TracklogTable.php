 ...
 * @since  1.5
 */
class TracklogTable extends Table implements VersionableTableInterface
{
	/**
	 * Constructor
	...
	{
		$this->typeAlias = 'com_gatracklog.tracklog';
		parent::__construct('#__gatracklog_tracklogs', 'id', $db);
	...
	{
		return 'com_gatracklog.tracklog';
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!$user->authorise('core.admin', 'com_gatracklog.tracklog.' . $array['id'])) {
			$actions         = Access::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_gatracklog/access.xml',
				"/access/section[@name='tracklog']/"
			);
			$default_actions = Access::getAssetRules('com_gatracklog.tracklog.' . $array['id'])->getData();
			$array_Access   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_gatracklog.tracklog.' . (int) $this->$k;
	}
	...
	protected function _getAssetParentId($table = null, $id = null)
	{
		...
		$assetParent->loadByName('com_gatracklog');
