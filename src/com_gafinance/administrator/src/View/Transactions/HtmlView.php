...
namespace GlennArkell\Component\Gafinance\Administrator\View\Transactions;
...
class HtmlView extends BaseHtmlView
{
	...
	{
		$compName = 'gafinance';
		$progNameL = 'transaction';
		$progNameC = 'Transaction';
        ...
        $compVersion = GafinanceHelper::getComponentVersion();
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.created_date' => Text::_('COM_GAFINANCE_CREATED_DATE'),
			'a.modified_date' => Text::_('COM_GAFINANCE_MODIFIED_DATE'),
		);
	}
