...
<form action="<?php echo Route::_('index.php?option=com_gafinance&view=accounts'); ?>" method="post"
			...
			<div id="j-main-container" class="j-main-container">
				...
				<table class="table table-striped" id="accountList">
					...
					<tr>
						...
						<th class='left'>
							<?php echo HTMLHelper::_('searchtools.sort',  'COM_GAFINANCE_ACCOUNTS_ACCNT_NAME', 'a.accnt_name', $listDirn, $listOrder); ?>
						</th>
						<th class='left'>
							<?php echo HTMLHelper::_('searchtools.sort',  'COM_GAFINANCE_ACCOUNTS_ACCNT_BSB', 'a.accnt_bsb', $listDirn, $listOrder); ?>
						</th>
						<th class='left'>
							<?php echo HTMLHelper::_('searchtools.sort',  'COM_GAFINANCE_ACCOUNTS_ACCNT_NUMBER', 'a.accnt_number', $listDirn, $listOrder); ?>
						</th>
						<th class='left'>
					...
					<?php foreach ($this->items as $i => $item) :
						...
						<tr class="row<?php echo $i % 2; ?>">
							...
							<?php if (isset($this->items[0]->state)): ?>
								<td class="center">
									<?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'accounts.', $canChange, 'cb'); ?>
								</td>
							<?php endif; ?>
							...
							<td>
								...
								<?php endif; ?>
								<?php if ($canEdit) : ?>
									<a href="<?php echo Route::_('index.php?option=com_gafinance&task=account.edit&id='.(int) $item->id); ?>">
									<?php echo $this->escape($item->accnt_name); ?></a>
								<?php else : ?>
