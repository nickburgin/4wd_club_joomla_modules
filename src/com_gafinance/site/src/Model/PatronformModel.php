 ...
 * @since  1.6
 */
class PatronformModel extends FormModel
{
    private $item = null;
    ...
    protected function populateState()
    {
        ...
        if (Factory::getApplication()->input->get('layout') == 'edit') {
                $id = Factory::getApplication()->getUserState('com_gafinance.edit.patron.id');
        } else {
                $id = Factory::getApplication()->input->get('id');
                Factory::getApplication()->setUserState('com_gafinance.edit.patron.id', $id);
        }

        $this->setState('patron.id', $id);
        ...
        if (isset($params_array['item_id'])) {
                $this->setState('patron.id', $params_array['item_id']);
        }
     ...
     */
    public function getTable($type = 'Patron', $prefix = 'Administrator', $config = array())
    {
    ...
    {
        // Get the id.
        $id = (!empty($id)) ? $id : (int) $this->getState('patron.id');
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_gafinance.patron', 'patronform', array(
                        'control'   => 'jform',
                        'load_data' => $loadData
                )
        );
    ...
    {
        $data = Factory::getApplication()->getUserState('com_gafinance.edit.patron.data', array());
    ...
    {
        $id    = (!empty($data['id'])) ? $data['id'] : (int) $this->getState('patron.id');
    ...
    public function delete($pk)
    {
        ...
        if (empty($pk)) {
            $pk = (int) $this->getState('patron.id');
        }
