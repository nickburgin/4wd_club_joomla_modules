...
class InvoicesModel extends ListModel
{
	...
	protected function getListQuery()
	{
		...
		// Join over the invoice type id reference.
		$query->select('i.invtype_name AS invoice_type_name');
		$query->join('LEFT', '#__gafinance_invtypes AS i ON i.id=a.invoice_type');
