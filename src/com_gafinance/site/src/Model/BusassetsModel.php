 ...
 * @since  1.6
 */
class BusassetsModel extends ListModel
{
	/**
	 * Constructor.
	...
	protected function getListQuery()
	{
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
				...
				$query->where('( a.asset_name LIKE ' . $search . ' OR a.serial_no LIKE ' . $search . ' )');
            }
        }
            
        // Add the list ordering clause.
        $orderCol  = $this->state->get('list.ordering', "a.asset_name");
