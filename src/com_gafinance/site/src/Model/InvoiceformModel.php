...
class InvoiceformModel extends FormModel
{
    ...
    protected function populateState()
    {
        ...
        if (Factory::getApplication()->input->get('layout') == 'edit') {
                $id = Factory::getApplication()->getUserState('com_gafinance.edit.invoice.id');
        } else {
                $id = Factory::getApplication()->input->get('id');
                Factory::getApplication()->setUserState('com_gafinance.edit.invoice.id', $id);
        }
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_gafinance.invoice', 'invoiceform', array(
                        'control'   => 'jform',
                        'load_data' => $loadData
                )
        );
