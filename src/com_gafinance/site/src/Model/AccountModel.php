 ...
 * @since  1.6
 */
class AccountModel extends ItemModel
{
    public $_item;
	...
	protected function populateState()
	{
		...
		if ($app->input->get('layout') == 'edit') {
			$id = $app->getUserState('com_gafinance.edit.account.id');
		} else {
			$id = $app->input->get('id');
			$app->setUserState('com_gafinance.edit.account.id', $id);
		}
	...
	public function getItemIdByAlias($alias)
	{
		...
		if (method_exists($this, 'getAliasFieldNameByView')) {
			$aliasKey   = $this->getAliasFieldNameByView('account');
		}
