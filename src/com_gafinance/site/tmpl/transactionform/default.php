...
<div class="transaction-edit front-end-edit">
	...
	<?php else : ?>
		...
		<form id="form-transaction"
			  action="<?php echo Route::_('index.php?option=com_gafinance&task=transactionform.save'); ?>"
			  method="post" class="form-validate form-horizontal" enctype="multipart/form-data">

			<?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', array('active' => 'general')); ?>
		
			<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'general', Text::_('COM_GAFINANCE_TRANSACTION_DETAILS', true)); ?>
				<div class="row-fluid">
					<div class="span10 form-horizontal">
						<fieldset name="general" class="adminform">
							<legend><?php echo Text::_('COM_GAFINANCE_TRANSACTION_DETAILS'); ?></legend>
							<?php echo $this->form->renderFieldset('general'); ?>

							<?php if (isset($this->item->tran_file) && $this->item->tran_file > '') : ?>
								<div class="control-group">
									<div class="control-label"><?php echo $this->form->getLabel('tran_file_txt'); ?></div>
									<div class="controls"><?php echo $this->form->getInput('tran_file_txt'); ?>
										<a class="btn btn-danger btn-mini pull-left"
											href="<?php echo Route::_('index.php?option=com_gafinance&task=transaction.removeFile&id='.$this->item->id); ?>"
							...
							<?php else: ?>
								<?php echo $this->form->renderField('tran_file'); ?>
								<input type="hidden" name="jform[tran_file_txt]" value="" />
							<?php endif; ?>
						</fieldset>
					</div>
				</div>
			...
			<div class="control-group">
				<div class="controls">
					...
					<a class="btn btn-danger"
					   href="<?php echo Route::_('index.php?option=com_gafinance&task=transactionform.cancel'); ?>"
