...
if ($this->params->get('page_title', '') > '') {
	...
	echo '<h1>'.Text::_('COM_GAFINANCE_TITLE_PATRON').'</h1>';
}
?>
...
<div class="item_fields">
	...
	<table class="table">
		...
		<tr>
			<th><?php echo Text::_('COM_GAFINANCE_FORM_LBL_PATRON_NAME'); ?></th>
			<td><?php echo $this->item->name; ?></td>
		</tr>

		<tr>
			<th><?php echo Text::_('COM_GAFINANCE_FORM_LBL_PATRON_ADDRESS'); ?></th>
			<td><?php echo $this->item->address; ?></td>
		</tr>

		<tr>
			<th><?php echo Text::_('COM_GAFINANCE_FORM_LBL_PATRON_PHONE'); ?></th>
			<td><?php echo $this->item->phone; ?></td>
		</tr>

		<tr>
			<th><?php echo Text::_('COM_GAFINANCE_FORM_LBL_PATRON_EMAIL'); ?></th>
			<td><?php echo $this->item->email; ?></td>
		</tr>

		<tr>
			<th><?php echo Text::_('COM_GAFINANCE_FORM_LBL_PATRON_CONT_NAME'); ?></th>
			<td><?php echo $this->item->cont_name; ?></td>
		</tr>

		<tr>
			<th><?php echo Text::_('COM_GAFINANCE_FORM_LBL_PATRON_CONT_PHONE'); ?></th>
			<td><?php echo $this->item->cont_phone; ?></td>
		</tr>
...
<?php /* ----------------------   Return button   ------------------------------ */ ?>
<a class="btn btn-secondary" href="<?php echo Route::_('index.php?option=com_gafinance&view=patrons'); ?>">
...
<?php if($canEdit && $this->item->checked_out == 0): ?>
	<a class="btn btn-warning"
		href="<?php echo Route::_('index.php?option=com_gafinance&task=patron.edit&id='.$this->item->id); ?>">
	...
	<div id="deleteModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="deleteModal" aria-hidden="true">
		...
		<div class="modal-footer">
			...
			<a class="btn btn-danger"
				href="<?php echo Route::_('index.php?option=com_gafinance&task=patron.remove&id=' . $this->item->id, false, 2); ?>">
