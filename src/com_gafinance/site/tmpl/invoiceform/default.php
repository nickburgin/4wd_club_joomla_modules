...
<div class="invoice-edit front-end-edit">
	...
	<?php else : ?>
		...
		<form id="form-invoice"
			  action="<?php echo Route::_('index.php?option=com_gafinance&task=invoiceform.save'); ?>"
			  method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
			
			<?php echo HTMLHelper::_('uitab.startTabSet', 'myTab', array('active' => 'general')); ?>
		
			<?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'general', Text::_('COM_GAFINANCE_INVOICE_DETAILS', true)); ?>
				<div class="row-fluid">
					<div class="span10 form-horizontal">
						<fieldset name="general" class="adminform">
							<legend><?php echo Text::_('COM_GAFINANCE_INVOICE_DETAILS'); ?></legend>
			...
			<div class="control-group">
				<div class="controls">
					...
					<a class="btn btn-danger"
					   href="<?php echo Route::_('index.php?option=com_gafinance&task=invoiceform.cancel'); ?>"
