...
if ($this->params->get('page_title', '') > '') {
	...
	echo '<h1>'.Text::_('COM_GAFINANCE_TITLE_BUSASSET').'</h1>';
}
?>
...
<div class="item_fields">
	...
	<table class="table">
		...
		<tr>
			<th><?php echo Text::_('COM_GAFINANCE_FORM_LBL_BUSASSET_ASSET_NAME'); ?></th>
			<td><?php echo $this->item->asset_name; ?></td>
		</tr>

		<tr>
			<th><?php echo Text::_('COM_GAFINANCE_FORM_LBL_BUSASSET_SERIAL_NO'); ?></th>
			<td><?php echo $this->item->serial_no; ?></td>
		</tr>

		<tr>
			<th><?php echo Text::_('COM_GAFINANCE_FORM_LBL_BUSASSET_MODEL_NO'); ?></th>
			<td><?php echo $this->item->model_no; ?></td>
		</tr>

		<tr>
			<th><?php echo Text::_('COM_GAFINANCE_FORM_LBL_BUSASSET_ASSET_DESC'); ?></th>
			<td><?php echo $this->item->asset_desc; ?></td>
		</tr>

		<tr>
			<th><?php echo Text::_('COM_GAFINANCE_FORM_LBL_BUSASSET_ASSET_DATE'); ?></th>
			<td><?php echo HTMLHelper::date($this->item->asset_date, Text::_('COM_GAFINANCE_DISPLAY_DATE'), 'UTC'); ?></td>
		</tr>

		<tr>
			<th><?php echo Text::_('COM_GAFINANCE_FORM_LBL_BUSASSET_ASSET_VALUE'); ?></th>
			<td><?php echo $this->item->asset_value; ?></td>
		</tr>
		...
		<tr>
			<th><?php echo Text::_('COM_GAFINANCE_FORM_LBL_BUSASSET_ASSET_IMG'); ?></th>
			<td><?php echo '<img src="'.$this->item->asset_img.'" />'; ?></td>
		</tr>
...
<?php /* ----------------------   Return button   ------------------------------ */ ?>
<a class="btn btn-secondary" href="<?php echo Route::_('index.php?option=com_gafinance&view=busassets'); ?>">
...
<?php if($canEdit && $this->item->checked_out == 0): ?>
	<a class="btn btn-warning"
		href="<?php echo Route::_('index.php?option=com_gafinance&task=busasset.edit&id='.$this->item->id); ?>">
	...
	<div id="deleteModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="deleteModal" aria-hidden="true">
		...
		<div class="modal-footer">
			...
			<a class="btn btn-danger"
				href="<?php echo Route::_('index.php?option=com_gafinance&task=busasset.remove&id=' . $this->item->id, false, 2); ?>">
