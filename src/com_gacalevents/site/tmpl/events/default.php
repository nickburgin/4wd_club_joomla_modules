...
<?php if ($this->items) : ?>
	...
	<p>&nbsp;</p>
	<?php if ($canCreate) : ?>
		<a href="<?php echo Route::_($nuURL); ?>" class="btn btn-success btn-small">
           <i class="icon-plus"></i> <?php echo Text::_('COM_GACALEVENTS_ADD_ITEM'); ?>
		</a>
		<?php if ($show_editor) : ?>
			<a href="<?php echo Route::_($edURL); ?>" class="btn btn-secondary btn-small">
				<i class="icon-edit"></i> <?php echo Text::_('COM_GACALEVENTS_SHOW_EDITOR'); ?>
			</a>
		<?php endif; ?>
	<?php endif; ?>
