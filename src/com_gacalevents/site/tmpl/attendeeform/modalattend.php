...
$event_id = $app->getInput()->get('event_id', 0, 'int');
$user_id = $app->getInput()->get('attendee', 0, 'int');
//$event_id = Factory::getApplication()->getUserState('com_gacalevents.edit.attendee.event_id');
//$user_id = $app->getUserState('com_gacalevents.edit.attendee.attendee');
...
//GacaleventsHelper::gaPrint($event_id);
?>
...
<div class="attendee-edit front-end-edit">
    ...
    <div class="form-horizontal">
        <div class="row-fluid">
			...
			<?php echo $this->form->renderField('attending'); ?>
