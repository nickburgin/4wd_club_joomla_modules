...
class AttendeeModel extends AdminModel
{
	 ...
	 * @since   3.2
	 */
	public $typeAlias = 'com_gacalevents.attendee';
	...
	public function getForm($data = array(), $loadData = true)
	{
            ...
            // Get the form.
            $form = $this->loadForm( 'com_gacalevents.attendee', 'attendee', array('control' => 'jform', 'load_data' => $loadData ) );
	...
	/**
	 * Method to duplicate an Attendee
	...
	protected function prepareTable($table)
	{
		if (empty($table->id)) {
			...
			if (@$table->ordering === '') {
				...
				$db->setQuery('SELECT MAX(ordering) FROM #__gacalevents_attendees');
				$max             = $db->loadResult();
