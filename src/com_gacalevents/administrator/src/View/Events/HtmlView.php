...
namespace GlennArkell\Component\Gacalevents\Administrator\View\Events;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar()
	{
		...
		if ($canDo->get('core.edit.state')  || count($this->transitions ?? array())) {
        ...
        $compVersion = GacaleventsHelper::getComponentVersion();
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.created_date' => Text::_('COM_GACALEVENTS_CREATED_DATE'),
			'a.modified_date' => Text::_('COM_GACALEVENTS_MODIFIED_DATE'),
		);
	}
