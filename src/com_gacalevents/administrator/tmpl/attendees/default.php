...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_gacalevents&task=attendees.saveOrderAjax&tmpl=component';
    HTMLHelper::_('sortablelist.sortable', 'attendeeList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}

?>

<form action="<?php echo Route::_('index.php?option=com_gacalevents&view=attendees'); ?>" method="post"
			...
			<div id="j-main-container" class="j-main-container">
				...
				<table class="table table-striped" id="attendeeList">
					...
					<tr>
						...
						<th class='left'>
						<?php echo HTMLHelper::_('searchtools.sort',  'COM_GACALEVENTS_ATTENDEES_ATTENDEE', 'a.pub_name', $listDirn, $listOrder); ?>
						</th>
						<th class='left'>
						<?php echo HTMLHelper::_('searchtools.sort',  'COM_GACALEVENTS_ATTENDEES_EVENT', 'e.title', $listDirn, $listOrder); ?>
						</th>
						<th class='left'>
						<?php echo HTMLHelper::_('searchtools.sort',  'COM_GACALEVENTS_EVENTS_DEPART_DATE', 'depart_date', $listDirn, $listOrder); ?>
						</th>
						<th class='left'>
					...
					<?php foreach ($this->items as $i => $item) :
                        ...
                        $edLink = GacaleventsHelper::getHTTPQuery(null, 'task', 'attendee.edit', 'id', $item->id);
						...
						<tr class="row<?php echo $i % 2; ?>">
							...
							<td>
								...
								<?php endif; ?>
								<?php if ($canEdit) : ?>
									<a href="<?php echo Route::_($edURL); ?>"><?php echo $this->escape($item->pub_name); ?></a>
								<?php else : ?>
							...
							<td>
								...
								echo $date > 0 ? HTMLHelper::_('date', $date, Text::_('COM_GACALEVENTS_DISPLAY_DATE_ABRV')) : '-';
								?>
							</td>
