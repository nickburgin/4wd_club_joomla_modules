...
class ProductModel extends AdminModel
{
	 ...
	 * @since   3.2
	 */
	public $typeAlias = 'com_gamerchandise.product';
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm( 'com_gamerchandise.product', 'product', array('control' => 'jform', 'load_data' => $loadData ) );
	...
	protected function prepareTable($table)
	{
		if (empty($table->id)) {
			...
			if (@$table->ordering === '') {
				...
				$db->setQuery('SELECT MAX(ordering) FROM #__gamerchandise_products');
				$max             = $db->loadResult();
