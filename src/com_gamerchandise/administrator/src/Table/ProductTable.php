...
class ProductTable extends Table implements VersionableTableInterface
{
	...
	{
		$this->typeAlias = 'com_gamerchandise.product';
		parent::__construct('#__gamerchandise_products', 'id', $db);
	...
	{
		return 'com_gamerchandise.product';
	}
	...
	public function bind($array, $ignore = '')
	{
		...
		if (!$user->authorise('core.admin', 'com_gamerchandise.product.' . $array['id'])) {
			$actions         = Access::getActionsFromFile(
				JPATH_ADMINISTRATOR . '/components/com_gamerchandise/access.xml',
				"/access/section[@name='product']/"
			);
			$default_actions = Access::getAssetRules('com_gamerchandise.product.' . $array['id'])->getData();
			$array_Access   = array();
	...
	protected function _getAssetName()
	{
		...
		return 'com_gamerchandise.product.' . (int) $this->$k;
	}
